...
- Public layout: shared `templates/base.html` uses a wide 1600px content container, full-width phone layout, and aggressive word wrapping for long legacy strings/URLs.
